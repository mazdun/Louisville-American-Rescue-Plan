...
By far, the largest chunk of funding so far has gone to affordable housing (\$89 million). The healthy neighborhoods portion of funding inclues money for Louisville's libraries and parks, among other areas.
...
**Deliverable:** GLP will analyze and visualize the number of young people (ages 18-24) who are registered to vote and who have actually voted. 

Data Sources: [Kentucky State Board of Elections](https://elect.ky.gov/Resources/Pages/Turnout.aspx); Note: There is only statewide voter data by age. For county-level data, GLP will file an information request with the Jefferson County Clerk.
